...
def summarize_cluster():
    ...
    elif TEST_TYPE.lower() == "soak":
        df = pd.DataFrame(records, index=["Test 1", "Test 2"])
    else:
        raise SystemExit(f"❌ Niewlasciwy rodzaj testu")
